...
export default function DiscountBrandAwarenessPamphletTwo() {
    return (
        <ImageBackground source={require('../Assets/Images/image13.png')} style={styles.bgImageComp}>
            ...
            <View>
                ...
                <View style={styles.rowView}>
                    <FontAwesome name="phone" size={30} color={Colors.blackDark} />
                    <Text style={{ fontSize: FontSize.fontSize16, color: Colors.blackDark, paddingLeft: 10 }}>+91 87xxxxxx56</Text>
                </View>
            </View>
